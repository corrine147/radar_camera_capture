import header as hd
# 配置基础DDM波形，使用两次循环配置移相码(后续均采样这种方式),不使用内部负载突降模式

# 设置参数，t0~t6,slope1,slope2,NSTART
# 这一组对应0.2m分辨率,512个采样点，384个chirp，注意修改采样数和chirp数
t_config = [20, 2, 20.48, 2, 6.12, 3.2, 1]            # 0.2m
slope1 = 36.5
primary_file_name = "ddm_0.2m_512_384_pa_primary.dat"
secondary_file_name = "ddm_0.2m_512_384_pa_secondary.dat"
