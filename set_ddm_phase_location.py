...
# primary_file_name = "C:/Infineon/set_code/config_waveform-main/config_waveform-main/waveform20251020/ddm_0.65m_768_384_primary_phase_neg.dat"
# secondary_file_name = "C:/Infineon/set_code/config_waveform-main/config_waveform-main/waveform20251020/ddm_0.65m_768_384_secondary_phase_neg.dat"
primary_file_name = "C:/Infineon/CTRX8191-Radar-eval-kit_Strata_2.6.1/ramp_designs/ddm_0.2m_512_384_primary_new.dat"
secondary_file_name = "C:/Infineon/CTRX8191-Radar-eval-kit_Strata_2.6.1/ramp_designs/ddm_0.2m_512_384_secondary_new.dat"
...
# 循环操作码，设置循环次数，子带数   最后一位08为8个子带，0C为12个子带  
...
# 修改相位操作码2，用于设置每个chirp的循环相位码，这里分12个子带
modify_phase_code_words2 = ['B3','05','44','00',            # 修改相位操作码，设置循环相位，24~25 相位符号反转，影响子带排列顺序
                            '03','10','0C','2B']
ddm_words.append(modify_phase_code_words2)
...
for i in range(0,len(secondary_list)):
    ...
    #     secondary_list[i+1] = '1A'                          # 从芯片相位设置 相位符号为正
    ...
    if secondary_list[i] == 'B3':
        secondary_list[i+1] = '1A'                          # 从芯片相位设置 相位符号为负，影响子带排列顺序
