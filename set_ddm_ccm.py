...
# 修改频率偏移值1，用于设置初始频率为0，跳频波形专属
modify_offset_code_words1 = ['A0','10','00','00',     
                             '00','00','00','00']
...
# 修改频率偏移值2，用于设置跳频频率为，跳频波形专属
modify_offset_code_words2 = ['A0','20','00','00',     
                             '00','00','00','00']
NOFFSET = round(freq_offset/(2**(-16) *300))*16
offset_hex = hd.writeConfigValue(hex(NOFFSET))
hd.copyData(modify_offset_code_words2, offset_hex, 4)
