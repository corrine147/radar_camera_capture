import header as hd
from set_phase_infineon import phase_setting
Tx_num = 8
band_total_num = 32
...
# 配置基础DDM波形，使用两次循环配置移相码(后续均采样这种方式)，移相码添加到有效负载段ADC数据正常
...
# t_config = [20, 2, 10.24, 2, 3.56, 3.2, 1]            # 0.73  187.5m 50MSa/s
# slope1 = 20                                           # 0.73  187.5m 50MSa/s

# t_config = [20, 2, 15.36, 2, 4.84, 3.2, 1]            # 0.65  250m 50MSa/s
# slope1 = 15                                           # 0.65  250m 50MSa/s

# t_config = [20, 2, 30.72, 2, 8.68, 3.2, 1]            # 基琳微 0.65  250m 50MSa/s
# slope1 = 24.4                                           # 基琳微 0.65  250m 50MSa/s

t_config = [20, 2, 10.24, 2, 3.56, 3.2, 1]            # 基琳微 0.65  250m 50MSa/s
slope1 = 12.2                                          # 基琳微 0.65  250m 50MSa/s
...
# slope1 = 20
# primary_file_name = "ddm_0.2m_512_384_primary_phase1.dat"
# secondary_file_name = "ddm_0.2m_512_384_secondary_phase1.dat"

# primary_file_name = "C:/Infineon/set_code/config_waveform-main/config_waveform-main/waveform20251020/ddm_0.98m_512_384_primary_phase_neg.dat"
# secondary_file_name = "C:/Infineon/set_code/config_waveform-main/config_waveform-main/waveform20251020/ddm_0.98m_512_384_secondary_phase_neg.dat"
# primary_file_name = "C:/Infineon/set_code/config_waveform-main/config_waveform-main/waveform20251020/ddm_0.73m_512_384_primary_phase_neg.dat"
# secondary_file_name = "C:/Infineon/set_code/config_waveform-main/config_waveform-main/waveform20251020/ddm_0.73m_512_384_secondary_phase_neg.dat"
# primary_file_name = "C:/Infineon/set_code/config_waveform-main/config_waveform-main/waveformjlw20251202/ddm_0.2m_1536_768_primary_phase_neg.dat"
# secondary_file_name = "C:/Infineon/set_code/config_waveform-main/config_waveform-main/waveformjlw20251202/ddm_0.2m_1536_768_secondary_phase_neg.dat"
primary_file_name = "C:/Infineon/set_code/config_waveform-main/config_waveform-main/waveformjlw20251202/ddm_0.2m_1536_768_primary_phase_neg.dat"
secondary_file_name = "C:/Infineon/set_code/config_waveform-main/config_waveform-main/waveformjlw20251202/ddm_0.2m_1536_768_secondary_phase_neg.dat"
...
# 循环操作码，设置循环次数，0x0180->384,0x000C->12,0x0020->32,0x0010->16
loop_code_words1 = ['E0','01','00','10']                    # 循环操作码，开始循环，外部循环
...
# 循环操作码，设置循环次数，子带数   最后一位08为8个子带，0C为12个子带，18为24个子带，20为32个子带   
loop_code_words1 = ['E0','01','00','20']                    # 循环操作码，开始循环，内部循环
ddm_words.append(loop_code_words1)
...
# # 修改相位操作码2，用于设置每个chirp的循环相位码，这里分24个子带
# modify_phase_code_words2 = ['B2','10','08','2B',            # 修改相位操作码，设置循环相位，24~25 相位未反转
#                             '02','20','08','60']
# ddm_words.append(modify_phase_code_words2)

# 修改相位操作码2，用于设置每个chirp的循环相位码，这里分24个子带
# modify_phase_code_words2 = ['B3','10','0C','2B',            # 修改相位操作码，设置循环相位，24~25 相位符号反转
#                             '03','20','0C','60']
# ddm_words.append(modify_phase_code_words2)

# 修改相位操作码2，用于设置每个chirp的循环相位码

print(ddm_words)
print('add:')
ddm_words.append(phase_code[0:8])
print(ddm_words)
...
# # 修改相位操作码2，用于设置每个chirp的循环相位码，这里分12个子带
# modify_phase_code_words2 = ['B3','05','44','00',            # 修改相位操作码，设置循环相位，24~25 相位符号反转
#                             '03','10','0C','2B']
# ddm_words.append(modify_phase_code_words2)


# # 修改相位操作码2，用于设置每个chirp的循环相位码，这里分12个子带
# modify_phase_code_words2 = ['B2','05','44','00',            # 修改相位操作码，设置循环相位，24~25 相位符号为正
#                             '02','10','08','2B']
# ddm_words.append(modify_phase_code_words2)
...
for i in range(0,len(secondary_list)):
    ...
    #     secondary_list[i+1] = '12'                          # 从芯片相位设置 相位符号为正
    #     secondary_list[i+2] = 'CC'
    #     secondary_list[i+3] = '55'
    #     secondary_list[i+4] = '03'
    #     secondary_list[i+5] = '02'
    #     secondary_list[i+6] = 'CC'
    #     secondary_list[i+7] = '20'

    # if secondary_list[i] == 'B2':
    #     secondary_list[i+1] = '12'                          # 从芯片相位设置 相位符号为负
    ...
    #     secondary_list[i+7] = '20'
        ...
        print(secondary_list)
    if secondary_list[i] == phase_code[0]:
        secondary_list[i:i+8] = phase_code[8:16]                          # 从芯片相位设置
        print('secondary_list')
        print(secondary_list)
